...
const StringUtils = require('gerador-boletos/lib/utils/string-utils')
const pad = StringUtils.pad;
const insert = StringUtils.insert;

const CodigoDeBarrasBuilder = require('gerador-boletos/lib/boleto/codigo-de-barras-builder');
